...
public class GenericService {
	...
	public LineSegment savePolyline(LineSegment lineSegment) {
		...
		for(Polyline pl : lineSegment.getPolylines()) {
			...
			jdbcTemplate.update(userSql, new Object[] {lineSegment.getLineId(), pl.getId().getOrder(), pl.getLatitude(), pl.getLongitude()}, new int[] {Types.INTEGER,Types.INTEGER,Types.DOUBLE,Types.DOUBLE,});
		}
